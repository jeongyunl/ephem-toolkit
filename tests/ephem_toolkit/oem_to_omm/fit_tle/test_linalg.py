...
from ephem_toolkit.oem_to_omm.fit_tle import linalg
...
class TestSolveLinearSystem:
    ...
    def test_solve_3x3_system(self) -> None:
        ...
        matrix = np.array([[2.0, 1.0, 1.0], [1.0, 3.0, 2.0], [1.0, 1.0, 4.0]])
    ...
    def test_solve_with_pivoting(self) -> None:
        ...
        matrix = np.array([[0.0, 2.0, 1.0], [1.0, 1.0, 2.0], [2.0, 1.0, 1.0]])
    ...
    def test_near_singular_matrix_returns_none(self) -> None:
        ...
        matrix = np.array([[1.0, 2.0], [1.0, 2.0 + 1e-16]])
...
class TestSolveWeightedLeastSquares:
    ...
    def test_solve_overdetermined_system(self) -> None:
        ...
        design_matrix = np.array([[1.0, 0.0], [1.0, 1.0], [1.0, 2.0], [1.0, 3.0]])
    ...
    def test_solve_exact_fit(self) -> None:
        ...
        design_matrix = np.array([[1.0, 2.0], [3.0, 4.0]])
    ...
    def test_regularization_prevents_singular(self) -> None:
        ...
        design_matrix = np.array(
            [[1.0, 1.0 + 1e-10], [2.0, 2.0 + 2e-10], [3.0, 3.0 + 3e-10]]
        )
