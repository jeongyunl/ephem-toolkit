...
**Not started.** This document tracks the implementation of [POETRY_PACKAGING_PLAN.md](POETRY_PACKAGING_PLAN.md). No Poetry metadata or package migration has been added yet.

## Checklist

- [ ] Inventory reusable modules, scripts, imports, data files, and runtime dependencies.
- [ ] Record baseline Python tests and representative CLI smoke tests.
