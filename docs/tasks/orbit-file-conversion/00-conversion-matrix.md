...
| OMM-TLE-REFIT | OMM | TLE | Composed SGP4 refit | Propagation/fitting | `propagate-omm` → OEM → `oem-to-tle` | Any supported declared mean-element theory | Reference OEM | SGP4 mean elements/TLE | Propagation settings, fit span, fit report | Task 10 in progress |
