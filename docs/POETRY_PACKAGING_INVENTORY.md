...
| `src/propagate_orbit/propagate_orbit.py` | `python3 src/propagate_orbit/propagate_orbit.py -i STATE [-d DURATION] [--oem OUTPUT]` | Propagate a Cartesian state with configured models. |
...
| `src/propagate_orbit/propagate_orbit.py` | `propagate-orbit` |
