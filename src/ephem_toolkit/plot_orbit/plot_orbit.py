...
def _compute_rtn_velocity_direction_vector(state_m: np.ndarray) -> np.ndarray:
    ...
    position_norm: float = float(np.linalg.norm(position_m))
    ...
    angular_momentum_norm: float = float(np.linalg.norm(angular_momentum_vector))
    ...
    velocity_norm: float = float(np.linalg.norm(velocity_rtn))
...
def save_or_show_figure(figure: Figure, output_file: str | None) -> None:
...
def plot_state_vectors(
    ...
    axis_3d.scatter(
        x_km[0], y_km[0], z_km[0], c="g", s=80, marker=MarkerStyle("o"), label="Start"
    )
    axis_3d.scatter(
        x_km[-1], y_km[-1], z_km[-1], c="r", s=80, marker=MarkerStyle("x"), label="End"
    )
    ...
    axis_xy.scatter(
        x_km[0], y_km[0], c="g", s=80, marker=MarkerStyle("o"), label="Start"
    )
    axis_xy.scatter(
        x_km[-1], y_km[-1], c="r", s=80, marker=MarkerStyle("x"), label="End"
    )
    ...
    axis_xz.scatter(
        x_km[0], z_km[0], c="g", s=80, marker=MarkerStyle("o"), label="Start"
    )
    axis_xz.scatter(
        x_km[-1], z_km[-1], c="r", s=80, marker=MarkerStyle("x"), label="End"
    )
    ...
    axis_yz.scatter(
        y_km[0], z_km[0], c="g", s=80, marker=MarkerStyle("o"), label="Start"
    )
    axis_yz.scatter(
        y_km[-1], z_km[-1], c="r", s=80, marker=MarkerStyle("x"), label="End"
    )
